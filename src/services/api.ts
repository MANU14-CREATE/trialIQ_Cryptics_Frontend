...
import { ASSIGN_SITE_TO_SPONSOR_API, ASSIGN_SITE_TO_TRIAL_API, ASSIGN_SPONSOR_TO_TRIAL_API, CREATE_ORGANISATION_API, CREATE_ORGANISATION_DOCUMENTS_API, CREATE_PROVIDER_API, CREATE_ROLES_API, CREATE_SITE_API, CREATE_SPONSOR_API, CREATE_SPONSOR_DOC_API, CREATE_TRIAL_API, CREATE_USERS_API, DELETE_ORGANISATION_API, DELETE_ORGANISATION_DOC_API, DELETE_PROVIDER_API, DELETE_ROLES_API, DELETE_SITE_API, DELETE_SPONSOR, DELETE_SPONSOR_SINGLE_DOC_API, DELETE_SPONSOR_TO_TRIAL_API, DELETE_TRIAL_API, DELETE_USERS_API, EDIT_ROLES_API, EDIT_ROLES_PERMISSIONS_API, EDIT_TRIAL_DETAILS_API, FETCH_TRIAL_DETAILS_API, GET_ORGANISATION_DOCUMENTS_API, GET_ROLES_API, MODULES_API, ORGANISATION_API, PROVIDER_API, ROLES_API, SITES_API, SPONSOR_DOC_API, SPONSORS_API, TRIALS_API, UPDATE_ORGANISATION_API, UPDATE_ORGANISATION_DOCUMENT_API, UPDATE_PROVIDER_API, UPDATE_SITE_API, UPDATE_SPONSOR_API, UPDATE_TRIAL_API, UPDATE_USERS_API, USERS_API } from './apiCalls';
import {
  mockOrganizations,
  mockSponsors,
  mockSites,
...
class ApiService {
  ...
  async assignSiteToSponsor(id: string, data: any) {
    return new Promise((resolve, reject) => {
      ASSIGN_SITE_TO_SPONSOR_API(id, data, (res: any) => {
        if (res) {
          resolve(res);
        } else {
          resolve(res.data);
  ...
  async deleteSponsorToTrial(id: string, data: any) {
    return new Promise((resolve, reject) => {
      DELETE_SPONSOR_TO_TRIAL_API(id, data, (res: any) => {
        if (res) {
          resolve(res);
        } else {
          resolve(res.data);
