...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  if (collapsible === "none") {
    return (
      <div
        className={cn("flex flex-col bg-sidebar w-[--sidebar-width] h-full text-sidebar-foreground", className)}
        ref={ref}
        {...props}
      >
        {children}
...
const SidebarMenu = React.forwardRef<HTMLUListElement, React.ComponentProps<"ul">>(({ className, ...props }, ref) => (
  <ul ref={ref} data-sidebar="menu" className={cn("flex flex-col gap-1 w-full min-w-0", className)} {...props} />
));
